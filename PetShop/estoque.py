...
def atualizarestoque(opcao, atendimentoP, produtos):
    if opcao =="c":
...
def removerestoque(opcao, atendimentoP, produtos):
    if opcao == "d":
        ...
        if escolhaEstoque =="b":
            ...
            #perguntar a Guilherme porque o print de toda a parte de estoque,como, por exeplo, REMOVER ESTOQUE está ficando duplicado
